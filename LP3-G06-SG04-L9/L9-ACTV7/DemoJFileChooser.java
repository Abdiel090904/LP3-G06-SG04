...
public class DemoJFileChooser extends JFrame{
    ...
    public void analizarRuta() throws IOException {
        ...
        if (ruta != null && Files.exists(ruta)) {
            ...
            builder.append(String.format("Ultima modificacion: 5%n", Files.getLastModifiedTime(ruta)));
            ...
            if (Files.isDirectory(ruta)) {
                builder.append(String. format ("enContenido del directorio:%n"));
    ...
    private Path obtenerRutaArchivoDirectorio() {
        ...
        // si el usuario hizo clic en el botón Cancelar en el cuadro de dialogo, regresa
